...
Avoid Captcha If Exists
    ...
    IF    ${elemento_captcha} == ${True}
        ...
        ${file_exists}         Confirm if png already exists    TestScripts\Robot-Scripts\Robots\captcha.png           # Não Finalizado devido ao captcha não aparecer
        IF    ${file_exists} == ${True}
            Remove File    TestScripts\Robot-Scripts\Robots\captcha.png
        END
